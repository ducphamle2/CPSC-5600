...
int main()
{
    ...
    */
    kMeans.fit(colorList, nColors); // this does everything to get convergence & clusterize. Fit in the list of colors available & its size
    ...
    for (const auto &cluster : clusters)
    {
        ...
        cout << endl
             << endl
             << "cluster #" << ++i << " centered at " << centroid.hex_label()
             << ":" << endl;
    ...
    delete[] colorLabels;
    cout << endl
         << "Try displaying visualization file, " << filename << ", in a web browser!" << endl;
